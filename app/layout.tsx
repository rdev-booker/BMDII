...
export const metadata: Metadata = {
  ...
  description:
    'Approaching 40 years of specialized freight expertise in Eastern Ontario. Over-dimensional, open deck, industrial FTL, and cross-border shipping. Your trusted heavy freight partner.',
  keywords: [
